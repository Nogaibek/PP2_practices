...
#   3.1  Pencil (freehand) + Straight line  (with live preview)
#   3.2  Three brush sizes  (1=2px, 2=5px, 3=10px)
#   3.3  Flood-fill (BFS pixel fill)
#   3.4  Ctrl+S  saves canvas as timestamped PNG
#   3.5  Text tool  (click → type → Enter to commit, Esc to cancel)
# All Practice 10–11 shapes (rect, circle, eraser, color picker,
# square, right/equilateral triangle, rhombus) are preserved and
# respect the active brush size.
# ============================================================
